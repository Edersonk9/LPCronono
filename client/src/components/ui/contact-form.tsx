            ...
            <FormItem>
              ...
              <FormControl>
                <Input 
                  ...
                  className="w-full px-4 py-2 rounded-lg border-gray-700 border focus:border-primary bg-gray-800" 
                  {...field} 
                />
              </FormControl>
              <FormMessage />
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                <FormControl>
                  <SelectTrigger className="w-full px-4 py-2 rounded-lg border-gray-700 border focus:border-primary bg-gray-800">
            ...
            <FormItem>
              ...
              <FormControl>
                <Textarea 
                  ...
                  className="w-full px-4 py-2 rounded-lg border-gray-700 border focus:border-primary min-h-[120px] bg-gray-800" 
                  {...field} 
                />
              </FormControl>
              <FormMessage />
